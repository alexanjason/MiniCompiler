...
public class Movne implements Instruction {
    ...
    public Movne(Register r1, Value operand2)
    {
        this.r1 = r1;
        Operand2 = operand2;
    }
    ...
    public void replaceRegs(Map<String, Register> map, Set<String> spillSet)
    {
        ...
        {
            // TODO can r1 spill?
            System.err.println("movne r1 spilled " + r1.getString());
        }
        else
        {
            System.err.println("movne r1 NOT IN GRAPH: " + r1.getString());
        }
        ...
        if (Operand2 instanceof Local || Operand2 instanceof Register)
        {
            if (map.containsKey(Operand2.getString()))
            {
                ...
                System.err.println("movne r1 NOT IN GRAPH: " + Operand2.getString());
            }
        }
    }
