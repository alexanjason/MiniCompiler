...
public class Movge implements Instruction {
    ...
    public void replaceRegs(Map<String, Register> map, Set<String> spillSet)
    {
        ...
        {
            // TODO can r1 spill?
            System.err.println("movge r1 spilled " + r1.getString());
        }
        else
        {
            System.err.println("movge r1 NOT IN GRAPH: " + r1.getString());
        }
        ...
        if (Operand2 instanceof Local || Operand2 instanceof Register)
        {
            if (map.containsKey(Operand2.getString()))
            {
                ...
                System.err.println("movge Operand2 NOT IN GRAPH: " + Operand2.getString());
            }
        }
    }
